export default {
  ...
  printerDetail: {
    backToPrinters: '返回打印机列表',
    controlPanel: '控制',
    temperatures: '温度',
    fans: '风扇',
    motion: '移动',
    motionDisabledWhilePrinting: '打印进行中时无法移动或归零。',
    extruder: '挤出机',
    extrudeStep: '挤出步长 (mm)',
    tempIncrease: '提高目标温度',
    tempDecrease: '降低目标温度',
    extrudeColdWarning: '挤出前请将喷嘴加热至 170°C 以上。',
    misc: '速度与环境',
    lamp: '照明',
    settings: '打印机设置',
    settingsSaved: '设置已保存',
    cameraSettingsHint: '外置摄像头和平台检测请在',
    nozzleLeft: '喷嘴（左）',
    nozzleInfo: '喷嘴：{{diameter}}mm {{type}}（来自打印机）',
    loadStarted: '已发送进料命令',
    unloadStarted: '已发送退料命令',
    streamError: '摄像头流不可用',
    waitingForStatus: '正在连接打印机…',
    invalidId: '无效的打印机。',
    unknown: '未知',
    unknownModel: '未知型号',
  },
