export default {
  ...
  printerDetail: {
    backToPrinters: 'Volver a impresoras',
    controlPanel: 'Control',
    temperatures: 'Temperatura',
    fans: 'Ventiladores',
    motion: 'Movimiento',
    motionDisabledWhilePrinting: 'Movimiento y homing desactivados durante la impresión.',
    extruder: 'Extrusor',
    extrudeStep: 'Paso de extrusión (mm)',
    tempIncrease: 'Aumentar temperatura objetivo',
    tempDecrease: 'Disminuir temperatura objetivo',
    extrudeColdWarning: 'Calienta el nozzle por encima de 170°C antes de extruir.',
    misc: 'Velocidad y entorno',
    lamp: 'Lámpara',
    settings: 'Ajustes de impresora',
    settingsSaved: 'Ajustes guardados',
    cameraSettingsHint: 'Cámara externa y detección de plato se configuran en',
    nozzleLeft: 'Nozzle (izquierdo)',
    nozzleInfo: 'Nozzle: {{diameter}}mm {{type}} (de la impresora)',
    loadStarted: 'Comando de carga enviado',
    unloadStarted: 'Comando de descarga enviado',
    streamError: 'Transmisión de cámara no disponible',
    waitingForStatus: 'Conectando a la impresora…',
    invalidId: 'Impresora no válida.',
    unknown: 'Desconocido',
