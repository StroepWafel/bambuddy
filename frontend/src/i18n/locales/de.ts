export default {
  ...
  printerDetail: {
    backToPrinters: 'Zurück zu Druckern',
    controlPanel: 'Steuerung',
    temperatures: 'Temperatur',
    fans: 'Lüfter',
    motion: 'Bewegung',
    motionDisabledWhilePrinting: 'Bewegung und Referenzfahrt sind während des Drucks deaktiviert.',
    extruder: 'Extruder',
    extrudeStep: 'Extrusionsschritt (mm)',
    tempIncrease: 'Zieltemperatur erhöhen',
    tempDecrease: 'Zieltemperatur verringern',
    extrudeColdWarning: 'Düse auf über 170°C erhitzen vor dem Extrudieren.',
    misc: 'Geschwindigkeit & Umgebung',
    lamp: 'Lampe',
    settings: 'Druckereinstellungen',
    settingsSaved: 'Einstellungen gespeichert',
    cameraSettingsHint: 'Externe Kamera und Plattenerkennung werden konfiguriert unter',
    nozzleLeft: 'Düse (links)',
    nozzleInfo: 'Düse: {{diameter}}mm {{type}} (vom Drucker)',
    loadStarted: 'Filament laden gesendet',
    unloadStarted: 'Filament entladen gesendet',
    streamError: 'Kamerastream nicht verfügbar',
    waitingForStatus: 'Verbinde mit Drucker…',
    invalidId: 'Ungültiger Drucker.',
    unknown: 'Unbekannt',
