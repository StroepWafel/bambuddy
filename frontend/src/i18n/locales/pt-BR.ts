export default {
  ...
  printerDetail: {
    backToPrinters: 'Voltar às impressoras',
    controlPanel: 'Controle',
    temperatures: 'Temperatura',
    fans: 'Ventiladores',
    motion: 'Movimento',
    motionDisabledWhilePrinting: 'Movimento e homing desativados durante a impressão.',
    extruder: 'Extrusor',
    extrudeStep: 'Passo de extrusão (mm)',
    tempIncrease: 'Aumentar temperatura alvo',
    tempDecrease: 'Diminuir temperatura alvo',
    extrudeColdWarning: 'Aqueça o bico acima de 170°C antes de extrudir.',
    misc: 'Velocidade e ambiente',
    lamp: 'Lâmpada',
    settings: 'Configurações da impressora',
    settingsSaved: 'Configurações salvas',
    cameraSettingsHint: 'Câmera externa e detecção de placa em',
    nozzleLeft: 'Bico (esquerdo)',
    nozzleInfo: 'Bico: {{diameter}}mm {{type}} (da impressora)',
    loadStarted: 'Comando de carga enviado',
    unloadStarted: 'Comando de descarga enviado',
    streamError: 'Stream da câmera indisponível',
    waitingForStatus: 'Conectando à impressora…',
    invalidId: 'Impressora inválida.',
    unknown: 'Desconhecido',
