export default {
  ...
  printerDetail: {
    ...
    fans: 'Ventilateurs',
    motion: 'Mouvement',
    motionDisabledWhilePrinting: 'Mouvement et homing désactivés pendant l\'impression.',
    extruder: 'Extrudeur',
    extrudeStep: 'Pas d\'extrusion (mm)',
    tempIncrease: 'Augmenter la température cible',
    tempDecrease: 'Diminuer la température cible',
    extrudeColdWarning: 'Chauffer la buse au-dessus de 170°C avant d\'extruder.',
    misc: 'Vitesse et environnement',
    lamp: 'Lampe',
    settings: 'Paramètres imprimante',
    settingsSaved: 'Paramètres enregistrés',
    cameraSettingsHint: 'Caméra externe et détection plateau se configurent dans',
    nozzleLeft: 'Buse (gauche)',
    nozzleInfo: 'Buse : {{diameter}}mm {{type}} (imprimante)',
    loadStarted: 'Commande de chargement envoyée',
    unloadStarted: 'Commande de déchargement envoyée',
    streamError: 'Flux caméra indisponible',
    waitingForStatus: 'Connexion à l\'imprimante…',
    invalidId: 'Imprimante invalide.',
    unknown: 'Inconnu',
