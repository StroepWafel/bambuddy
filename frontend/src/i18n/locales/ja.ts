export default {
  ...
  printerDetail: {
    backToPrinters: 'プリンター一覧に戻る',
    controlPanel: '制御',
    temperatures: '温度',
    fans: 'ファン',
    motion: '移動',
    motionDisabledWhilePrinting: '印刷中は移動とホーミングは無効です。',
    extruder: 'エクストルーダー',
    extrudeStep: '押出しステップ (mm)',
    tempIncrease: '目標温度を上げる',
    tempDecrease: '目標温度を下げる',
    extrudeColdWarning: '押出し前にノズルを170°C以上に加熱してください。',
    misc: '速度と環境',
    lamp: 'ランプ',
    settings: 'プリンター設定',
    settingsSaved: '設定を保存しました',
    cameraSettingsHint: '外部カメラとプレート検出は次で設定',
    nozzleLeft: 'ノズル（左）',
    nozzleInfo: 'ノズル: {{diameter}}mm {{type}}（プリンター報告）',
    loadStarted: 'フィラメント装載コマンドを送信',
    unloadStarted: 'フィラメント排出コマンドを送信',
    streamError: 'カメラストリームを利用できません',
    waitingForStatus: 'プリンターに接続中…',
    invalidId: '無効なプリンターです。',
    unknown: '不明',
    unknownModel: '不明なモデル',
  },
