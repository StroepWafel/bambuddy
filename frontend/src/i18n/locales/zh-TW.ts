export default {
  ...
  printerDetail: {
    backToPrinters: '返回印表機列表',
    controlPanel: '控制',
    temperatures: '溫度',
    fans: '風扇',
    motion: '移動',
    motionDisabledWhilePrinting: '列印進行中時無法移動或歸零。',
    extruder: '擠出機',
    extrudeStep: '擠出步長 (mm)',
    tempIncrease: '提高目標溫度',
    tempDecrease: '降低目標溫度',
    extrudeColdWarning: '擠出前請將噴嘴加熱至 170°C 以上。',
    misc: '速度與環境',
    lamp: '照明',
    settings: '印表機設定',
    settingsSaved: '設定已儲存',
    cameraSettingsHint: '外置攝影機與平台偵測請在',
    nozzleLeft: '噴嘴（左）',
    nozzleInfo: '噴嘴：{{diameter}}mm {{type}}（來自印表機）',
    loadStarted: '已傳送進料命令',
    unloadStarted: '已傳送退料命令',
    streamError: '攝影機串流不可用',
    waitingForStatus: '正在連線印表機…',
    invalidId: '無效的印表機。',
    unknown: '未知',
    unknownModel: '未知型號',
  },
