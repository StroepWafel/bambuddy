export default {
  ...
  printerDetail: {
    ...
    controlPanel: 'Controllo',
    temperatures: 'Temperatura',
    fans: 'Ventole',
    motion: 'Movimento',
    motionDisabledWhilePrinting: 'Movimento e homing disabilitati durante la stampa.',
    extruder: 'Estrusore',
    extrudeStep: 'Passo estrusione (mm)',
    tempIncrease: 'Aumenta temperatura obiettivo',
    tempDecrease: 'Diminuisci temperatura obiettivo',
    extrudeColdWarning: 'Riscalda l\'ugello sopra 170°C prima di estrudere.',
    misc: 'Velocità e ambiente',
    lamp: 'Lampada',
    settings: 'Impostazioni stampante',
    settingsSaved: 'Impostazioni salvate',
    cameraSettingsHint: 'Telecamera esterna e rilevamento piatto si configurano in',
    nozzleLeft: 'Ugello (sinistro)',
    nozzleInfo: 'Ugello: {{diameter}}mm {{type}} (dalla stampante)',
    loadStarted: 'Comando caricamento inviato',
    unloadStarted: 'Comando scarico inviato',
    streamError: 'Stream telecamera non disponibile',
    waitingForStatus: 'Connessione alla stampante…',
    invalidId: 'Stampante non valida.',
    unknown: 'Sconosciuto',
